/*  A program that shows how to create 1-D, 2-D, and 3-D arrays in C++.
    ...
    Additionally, you may want to consider using a vector instead
    of an array as they function very similarly. Vectors are
    implemented as dynamic arrays with list interface while arrays
